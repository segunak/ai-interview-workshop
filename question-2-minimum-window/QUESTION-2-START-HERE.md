...
> These instructions are also available at <https://segunakinyemi.com/ai-interview-workshop/question-2-minimum-window/>.
...
Direct AI to write your solution in the starter files below. Before running anything, predict what the output will be. Then run the tests and verify your solution works with the provided examples and edge cases (single character, no valid window, entire string is the answer).
