---
title: "Question 2: Longest Substring"
nav_order: 4
---
...
{: .important }
**Before you start:** Make sure you've selected the **Workshop Agent** in GitHub Copilot Chat. Open `QUESTION-2-START-HERE.md` in the `question-2-longest-substring` folder and keep it open while you work. This loads the AI context GitHub Copilot needs to help you effectively.
...
Direct AI to write your solution in `question-2-longest-substring/`. Before running anything, predict what the output will be. Then run the tests and verify your solution works with the provided examples and edge cases.
...
Your solution goes in **`solution.py`** in the `question-2-longest-substring/` folder. Open that file and write your code there.
