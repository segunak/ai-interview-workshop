...
{: .important }
The `ui-submission` tag is how form submissions are identified. Posts with this tag appear in the **UI Submissions** section of the live feed. Posts tagged `script-submission` appear in **Script Submissions**. Your form MUST always include `ui-submission`.
